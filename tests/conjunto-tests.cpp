...
TEST(mis_tests, tres_tipos_remover) {
    Conjunto<int> c;
...
TEST(mis_tests, insertar_duplicado) {
    Conjunto<int> c;
...
TEST(mis_tests, remover_no_existente) {
    Conjunto<int> c;
...
TEST(mis_tests, remover_de_vacio) {
    Conjunto<int> c;
...
TEST(mis_tests, pertenece_a_vacio) {
    Conjunto<int> c;
