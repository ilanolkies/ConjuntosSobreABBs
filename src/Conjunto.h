...
private:
    ...
    Nodo *bajar(Nodo *nodo, const T &v) const;

    Nodo *siguiente_nodo(Nodo *nodo) const;

    Nodo *minimo_subarbol(Nodo *raiz) const;

    Nodo *remover_subarbol(Nodo *raiz, const T &v) const;
};
